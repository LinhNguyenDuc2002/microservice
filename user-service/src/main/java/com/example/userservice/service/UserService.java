...
public interface UserService {
    ...
    Map<String, String> createTempUser(UserRegistration newUserRegistration) throws InvalidationException, JsonProcessingException, NoSuchAlgorithmException, InvalidKeyException;
