package com.example.servicefoundation.mail.message;
...
public final class EmailConstant {
    ...
    public final static String TEMPLATE_EMAIL_CREATE_ACCOUNT = "create-account.html";
    ...
    public final static String ARG_CREATE_ACCOUNT_SUBJECT = "[Blue shop] Notification of successful account creation";
}
