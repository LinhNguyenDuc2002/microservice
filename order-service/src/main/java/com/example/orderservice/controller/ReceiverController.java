...
public class ReceiverController {
    ...
    @PostMapping
    public ResponseEntity<Response<ReceiverDto>> add(@Valid @RequestBody ReceiverRequest receiverRequest) throws I18nException {
    ...
    public ResponseEntity<Response<ReceiverDto>> update(
            ...
            @Valid @RequestBody ReceiverRequest receiverRequest) throws I18nException {
        return ResponseUtil.wrapResponse(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Response<ReceiverDto>> get(@PathVariable String id) throws I18nException {
        return ResponseUtil.wrapResponse(
    ...
    public ResponseEntity<Response<List<ReceiverDto>>> getAll(@PathVariable String id) {
        return ResponseUtil.wrapResponse(
